...
| StarBook Mk VII Ultra 7 | Meteor Lake | [`soc/intel/meteor-lake/common`](soc/intel/meteor-lake/common) and the current [`2145:0002` audio package](soc/intel/audio/2145-0002/realtek-6.0.10034.1.zip) | Use the shared Meteor Lake package set, GNA package below, and this audio package. |
| StarFighter Mk II | Meteor Lake | [`soc/intel/meteor-lake/common`](soc/intel/meteor-lake/common) and [`2014:7017` audio](soc/intel/audio/2014-7017/realtek-6.0.9901.1.zip) | Use the shared Meteor Lake package set, GNA package below, and this audio package. It supports the Windows legacy `2014:7017` policy; do not substitute the ALC269 current-ID package. |
